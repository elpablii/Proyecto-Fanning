        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xl p-4">
          <div className="text-center max-w-md bg-gray-900 p-8 rounded-3xl border border-red-500/50 shadow-2xl shadow-red-500/20">
            ...
            <p className="text-gray-400 text-base mb-8">
              Esta película ha sido clasificada para mayores de 18 años. El vocabulario y los diálogos pueden contener lenguaje soez, referencias sexuales o violencia extrema.
            </p>
            <button 
