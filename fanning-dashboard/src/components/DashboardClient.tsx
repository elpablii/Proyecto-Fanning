...
export default function DashboardClient({ initialManifestData }: { initialManifestData: any }) {
  ...
  const [stats, setStats] = useState({
    ...
    movieList: [] as { title: string, count: number, type?: 'series' | 'movie', dialogues?: number, episodes: { name: string, count: number }[], posterUrl?: string | null, backdropUrl?: string | null }[],
    totalDialogues: 0
  });
