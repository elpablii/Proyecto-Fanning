...
with open('fanning-dashboard/public/data/pelis/Obi-Wan Kenobi.json', 'r', encoding='utf-8') as f:
...
with open('fanning-dashboard/public/data/2026/vocabulario_obi-wan_kenobi.json', 'w', encoding='utf-8') as f:
