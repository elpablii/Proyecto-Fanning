...
pdf_path = 'Diálogos/Diálogos Series/Dialogues from All Her Fault to improve the vocabulary in English.pdf'
...
# Buscar 'Episode 1:', 'Episode 2:', etc.
...
json_path = 'fanning-dashboard/public/data/pelis/All Her Fault.json'
...
print("Updated All Her Fault.json with dialogue counts")
