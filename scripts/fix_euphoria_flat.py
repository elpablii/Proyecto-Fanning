...
with open('fanning-dashboard/public/data/pelis/Euphoria.json', 'r', encoding='utf-8') as f:
...
for ep in correct_data.get('episodes', []):
    ...
    for v in ep.get('vocabulary', []):
        ...
        flat_words.append({
            ...
            "word": word,
            "translation": trans,
            "source_movie": f"Euphoria ({ep_name})",
            "year_processed": "2025",
            "global_frequency": 2
        })

with open('fanning-dashboard/public/data/2025/vocabulario_euphoria.json', 'w', encoding='utf-8') as f:
