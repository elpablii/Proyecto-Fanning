...
with open('fanning-dashboard/public/data/pelis/All Her Fault.json', 'r', encoding='utf-8') as f:
    correct_data = json.load(f)

# Create the flat array of words
flat_words = []
for ep in correct_data.get('episodes', []):
    ep_name = ep['name'] # e.g. "All Her Fault (Episode 1)"
...
with open('fanning-dashboard/public/data/2026/vocabulario_all_her_fault.json', 'w', encoding='utf-8') as f:
