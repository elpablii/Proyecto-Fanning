...
pdf_path = 'Diálogos/Diálogos Series/Dialogues from Pan Am to improve the vocabulary in English.pdf'
...
json_path = 'fanning-dashboard/public/data/pelis/Pan Am.json'
...
print("Updated Pan Am.json with dialogue counts")
