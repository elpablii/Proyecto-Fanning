...
with open('fanning-dashboard/public/data/pelis/Pan Am.json', 'r', encoding='utf-8') as f:
    correct_data = json.load(f)

# Create the flat array of words
flat_words = []
for ep in correct_data.get('episodes', []):
    ep_name = ep['name'] # e.g. "Pan Am (Episode 1)"
...
with open('fanning-dashboard/public/data/2026/vocabulario_pan_am.json', 'w', encoding='utf-8') as f:
